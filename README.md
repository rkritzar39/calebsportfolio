...
![JavaScript](https://img.shields.io/badge/JavaScript-44.8%25-f1e05a)
...
| :--- | :--- | :--- |
| **JavaScript** | 44.8% | Powers dynamic behavior, profile loading, sorting, time logic, Firestore updates, navigation interactions, Discord synchronization, Live Activity, and interactive interface features. |
| **CSS** | 36.3% | Controls visual design, responsive layouts, liquid-glass styling, animations, themes, device breakpoints, and hover effects. |
