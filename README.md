...
<!-- AUTO:BADGES-START -->
![Version](https://img.shields.io/badge/version-v27.0--rc.2-blue)
...
![JavaScript](https://img.shields.io/badge/JavaScript-54.3%25-f1e05a)
![HTML](https://img.shields.io/badge/HTML-23.0%25-e34c26)
![CSS](https://img.shields.io/badge/CSS-22.7%25-663399)
<!-- AUTO:BADGES-END -->
...
The project has been under development for **1 year, 7 months, and 20 days**.
...
| :--- | :--- | :--- |
| **JavaScript** | 54.3% | Powers dynamic behavior, profile loading, sorting, time logic, Firestore updates, navigation interactions, Discord synchronization, Live Activity, and interactive interface features. |
| **HTML** | 23.0% | Provides website structure, page sections, navigation, inline SVG icons, and content frameworks. |
| **CSS** | 22.7% | Controls visual design, responsive layouts, liquid-glass styling, animations, themes, device breakpoints, and hover effects. |
<!-- AUTO:LANGUAGES-END -->
