...
![CSS](https://img.shields.io/badge/CSS-37.5%25-663399)
![HTML](https://img.shields.io/badge/HTML-18.5%25-e34c26)
<!-- AUTO:BADGES-END -->
...
| **CSS** | 37.5% | Controls visual design, responsive layouts, liquid-glass styling, animations, themes, device breakpoints, and hover effects. |
| **HTML** | 18.5% | Provides website structure, page sections, navigation, inline SVG icons, and content frameworks. |
<!-- AUTO:LANGUAGES-END -->
