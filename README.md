...
![JavaScript](https://img.shields.io/badge/JavaScript-54.5%25-f1e05a)
![HTML](https://img.shields.io/badge/HTML-22.8%25-e34c26)
...
| :--- | :--- | :--- |
| **JavaScript** | 54.5% | Powers dynamic behavior, profile loading, sorting, time logic, Firestore updates, navigation interactions, Discord synchronization, Live Activity, and interactive interface features. |
| **HTML** | 22.8% | Provides website structure, page sections, navigation, inline SVG icons, and content frameworks. |
