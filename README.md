...
![JavaScript](https://img.shields.io/badge/JavaScript-44.1%25-f1e05a)
![CSS](https://img.shields.io/badge/CSS-36.8%25-663399)
![HTML](https://img.shields.io/badge/HTML-19.1%25-e34c26)
<!-- AUTO:BADGES-END -->
...
The project has been under development for **1 year, 7 months, and 28 days**.
...
| :--- | :--- | :--- |
| **JavaScript** | 44.1% | Powers dynamic behavior, profile loading, sorting, time logic, Firestore updates, navigation interactions, Discord synchronization, Live Activity, and interactive interface features. |
| **CSS** | 36.8% | Controls visual design, responsive layouts, liquid-glass styling, animations, themes, device breakpoints, and hover effects. |
| **HTML** | 19.1% | Provides website structure, page sections, navigation, inline SVG icons, and content frameworks. |
<!-- AUTO:LANGUAGES-END -->
