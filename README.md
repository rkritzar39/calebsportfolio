...
![CSS](https://img.shields.io/badge/CSS-38.3%25-663399)
![HTML](https://img.shields.io/badge/HTML-16.4%25-e34c26)
<!-- AUTO:BADGES-END -->
...
| **CSS** | 38.3% | Controls visual design, responsive layouts, liquid-glass styling, animations, themes, device breakpoints, and hover effects. |
| **HTML** | 16.4% | Provides website structure, page sections, navigation, inline SVG icons, and content frameworks. |
<!-- AUTO:LANGUAGES-END -->
